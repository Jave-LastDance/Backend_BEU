...
public class PersonCotroller {
    ...
    public ResponseEntity<String> actualizarToken(@RequestParam String username, @RequestParam String nuevoToken) {
        personS.actualizarToken(username, nuevoToken);
        return ResponseEntity.ok("Token actualizado exitosamente.");
    }
}
