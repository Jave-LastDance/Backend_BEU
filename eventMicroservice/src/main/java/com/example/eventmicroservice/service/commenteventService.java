...
public class commenteventService {
    ...
    /**
     * This method retrieves all comments associated with a specific event. It takes
     * the event's ID as a parameter and returns a list of comments related to that event.
     * @param idEvent
     * @return
     */
    ...
    /**
     * This method adds a new comment if no previous comment exists from the same user for the same event.
     * It takes a commentevent object representing the new comment. If the comment is unique (not already
     * posted by the user for the same event), it will be saved to the repository.
    ...
    /**
     * This method deletes a comment associated with a specific event and user. It takes the IDs of
     * the event and the user whose comment needs to be deleted, and removes the corresponding comment
     * from the repository.
     * @param idEvent
     * @param idUser
     */
