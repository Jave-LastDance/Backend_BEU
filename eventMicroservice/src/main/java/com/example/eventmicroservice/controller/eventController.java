...
@GetMapping("/users")
    ...
    /**
     *The method retrieves a list of eventDB objects associated with the specified id_beacon location using
    ...
    public ResponseEntity<List<event>> getEventPerBeacon(@PathVariable Integer id_beacon){
